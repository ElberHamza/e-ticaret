...
namespace e_ticaret_sitesi.Areas.Identity.Pages.Account.Manage
{
    public class EmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            if (user == null)
            {
                return NotFound($"Kullanıcı ID '{_userManager.GetUserId(User)}' ile yüklenemedi.");
            }
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                StatusMessage = "E-posta değiştirme onay bağlantısı gönderildi. Lütfen e-postanızı kontrol edin.";
