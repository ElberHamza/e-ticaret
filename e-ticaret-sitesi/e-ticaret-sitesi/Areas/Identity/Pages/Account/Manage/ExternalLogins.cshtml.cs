...
namespace e_ticaret_sitesi.Areas.Identity.Pages.Account.Manage
{
    public class ExternalLoginsModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            if (user == null)
            {
                return NotFound($"ID '{_userManager.GetUserId(User)}' ile kullanıcı yüklenemedi.");
            }
        ...
        public async Task<IActionResult> OnGetLinkLoginCallbackAsync()
        {
            ...
            if (info == null)
            {
                throw new InvalidOperationException($"Harici giriş bilgileri yüklenirken beklenmedik bir hata oluştu.");
            }
